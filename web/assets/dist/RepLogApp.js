        ...
        _createClass(RepLogApp, [{
            ...
            value: function handleNewFormSubmit(e) {
                ...
                this._saveRepLog(formData).then(function (data) {
                    ...
                    _this4._mapErrorsToForm(errorData);
                });
            }
        }, {
            key: '_saveRepLog',
    ...
    var Helper = function () {
        ...
        _createClass(Helper, [{
            ...
            value: function getTotalWeightString() {
                ...
                var wieght = this.calculateTotalWeight();
            ...
            key: '_calculateWieght',
            value: function _calculateWieght(repLogs) {
                var totalWeight = 0;
